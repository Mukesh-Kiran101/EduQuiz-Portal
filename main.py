        ...
        while True:
            ...
            if cho == "1":
                ...
                if stu_who == "1":  # sign-in
                    try:
                        cur.execute("insert into student values(%s,%s,%s,%s,%s);",
                                    (id_student, name_student, age_student, gender_student, grade_student))
                        mydb.commit()
                ...
                if chostu == "1":  # Mockup Quiz
                    ...
                    try:
                        cur.execute("insert into leaderboard values (%s,%s,%s,%s,%s,%s);",
                                    (id_student, name_student, grade, main_mark, time_main, date))
                        mydb.commit()
                        ...
                        if better(id_student, main_mark, time_main):
                            ...
                            print(
                                "Since your previous record is better that this , this score will not be considered !!")
                ...
                if login_teach(input("Enter your name : "), input("Enter your password : ")):
                    ...
                    if choteach == "1":
                        ...
                        if choteach1 == "1":
                            ...
                            cur.execute("insert into mockup_q values (%s,%s,%s,%s,%s,%s,%s);",
                                        (qmockno, qmockq, qmockop[0], qmockop[1], qmockop[2], qmockop[3], qmockans))
                            mydb.commit()
                            print("Done")
                            time.sleep(1)
                        ...
                        if choteach1 == "1":
                            ...
                            cur.execute("insert into questions values (%s ,%s,%s,%s,%s,%s,%s );",
                                        (qmaino, qmainq, qmainop[0], qmainop[1], qmainop[2], qmainop[3], qmainans))
                            mydb.commit()
                            print("Done")
                            time.sleep(1)
                        ...
                        print(
                            ">> since students can sign-in by themself, no add student.\n1.Remove Student\n2.Modify Student")
